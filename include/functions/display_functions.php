...
function display_search($criteria) {
	...
	//echo '<form method="GET" class="form-inline">';
		...
		<input type="text" id="address" name="address" value="'.$address.'" style="width:100%; margin-bottom:10px;" class="form-control" />
		</div>';
		...
		if($GLOBALS['categories_filter']=='1') {
			...
			<select id="category_id" name="category_id" style="width:100%; margin-bottom:10px;"
		...
		if($GLOBALS['max_distance_filter']=='1') {
			...
			echo '<div class="col-md-2 col-sm-12">
			<select id="max_distance" name="max_distance" style="width:100%; margin-bottom:10px;" class="form-control" onchange="form.submit();">';
			echo '<option value="">Select a distance</option>';
